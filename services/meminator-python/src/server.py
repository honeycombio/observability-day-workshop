...
tracer_provider.add_span_processor(CustomSpanProcessor()) # INSTR: add custom span processor, which puts the free_space on
...
def meminate():
    ...
    # Execute ImageMagick command to apply text to the image # INSTR: put this unit of work in its own span
